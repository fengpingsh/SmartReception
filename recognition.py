...
if len(sys.argv) != 5:
    print(
        ...
        "   ./face_recognition.py shape_predictor_5_face_landmarks.dat dlib_face_recognition_resnet_model_v1.dat path2face1 path2face2\n"
...
print("descriptor shape = {}".format( face_descriptor1.shape))
...
print("descriptor shape = {}".format( face_descriptor2.shape))

print("value = {}".format(1 - np.linalg.norm(np.array(face_descriptor1) - np.array(face_descriptor2))))
